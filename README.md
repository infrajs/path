...
# Содержит расширение [infrajs/config](https://github.com/infrajs/config)
Значения pathsearch расширяют область поиска, добавляются в $conf['search'] ещё папки производителей